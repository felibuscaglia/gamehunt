      ...
      {(games) => (
        <main className="w-10/12 mx-auto py-5">
          ...
          {games.length ? (
            ...
            <div className="text-center text-lg inset-1/2 absolute w-full" style={{ transform: 'translate(-50%, -50%)'}}>
              <p className="mb-4">🤔 Looks like you haven't posted any games yet</p>
              <Link
