      ...
      <div>
        ...
        <form className="flex flex-col">
          ...
          <div className="w-1/4 self-end">
            <Button
              text={user ? "Post comment" : "Login to comment"}
              textSize="small"
            />
          </div>
        </form>
        ...
        <article className="p-6 mb-3 ml-6 lg:ml-12 text-base bg-white border-t border-gray-200">
          <footer className="flex justify-between items-center mb-2">
            <div className="flex items-center">
              <p className="inline-flex items-center mr-3 text-sm text-gray-900 font-semibold">
                <img
        ...
        <article className="p-6 mb-3 text-base bg-white border-t border-gray-200">
          ...
          <p className="text-gray-500">
            This article provides great insights into the crucial aspects of UX
            design strategy. Thanks for sharing!
          </p>
          <div className="flex items-center mt-4 space-x-4">
            <button
              type="button"
